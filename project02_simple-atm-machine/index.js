...
if (pinAnswer.pin === myPin) {
    ...
    if (opsAnswer.operation === "Withdraw") {
        ...
        if (myBalance >= amountAns.amount) {
            ...
            console.log(chalk.greenBright(`${userName.name} your remaining balance is $${myBalance}`));
        }
        else {
        ...
        console.log(chalk.greenBright.bold(`${userName.name} your current balance is ${myBalance}`));
    }
